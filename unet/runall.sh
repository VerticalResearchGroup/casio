...
APP=$APPNAME-infer DT=$INFER_DT BS=$I_SMALL_BS NW=1 NI=1  $CASIO/utils/run_ncu.sh $INFER_CMD
APP=$APPNAME-infer DT=$INFER_DT BS=$I_LARGE_BS NW=1 NI=1  $CASIO/utils/run_ncu.sh $INFER_CMD
APP=$APPNAME-train DT=$TRAIN_DT BS=$T_SMALL_BS NW=1 NI=1  $CASIO/utils/run_ncu.sh $TRAIN_CMD
APP=$APPNAME-train DT=$TRAIN_DT BS=$T_LARGE_BS NW=1 NI=1  $CASIO/utils/run_ncu.sh $TRAIN_CMD
